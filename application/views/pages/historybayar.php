    ...
    <main>
        ...
        <div class="container-fluid">
            <div class="headcontent">
                <h2>Riwayat Pembayaranmu</h2>
                <!-- <div class="btn_group">
                    <a href="<?= site_url('kost') ?>" class="btn btn-default noactive" id="tipelist"> <i class="fas fa-bed fa-xs"></i> </a>
                    <a href="<?= site_url('listrik') ?>" class="btn btn-default noactive" id="tipelist" style="width: 40px;"> <i class="fas fa-bolt fa-xs"></i> </a>
                    <a href="#" class="btn btn-default active" id="tipelist"> <i class="fas fa-wifi fa-xs"></i> </a>
                </div> -->
            </div>
            <div class="card bodycontent">
                <div class="card-body">
                    <div class="tab-pane table-responsive">
                        <table id="table_history" class="table table-striped table-bordered" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    <td>ID Transaksi</td>
                                    <td>Bulan</td>
