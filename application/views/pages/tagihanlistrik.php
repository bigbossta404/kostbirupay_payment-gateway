        ...
        <div class="container-fluid">
            <div class="headcontent">
                ...
                <div class="btn_group">
                    ...
                    <a href="#" class="btn btn-default active" id="tipelist" style="width: 40px;"> <i class="fas fa-bolt fa-xs"></i> </a>
            ...
            <div class="card bodycontent">
                <div class="card-body">
                    <div class="tab-pane table-responsive">
                        <table id="tablelistrik" class="table table-striped table-bordered" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    <td>ID Bayar</td>
                                    <td>Bulan</td>
